        ...
        <div className="px-10">
          ...
          <div className="border-b border-gray-900/10 pb-12">
            <Form action="/admin/actions/tournament/proceed" method="POST">
              <h2 className="my-4 text-base font-semibold leading-7 text-gray-900">
          ...
          <div className="border-b border-gray-900/10 pb-12">
            <Form>
              ...
              <div className="my-10">
                <label htmlFor="customRange1" className=" mb-2 inline-block">
                  Scoring - speedRunLeniencyFactor
                </label>
                <input
                  type="range"
                  min="1"
                  ...
                  onMouseUp={(e) => {
                    createUpdateSettings('points')({
                      ...
                      maxPointsForSpeedRunning:
                        gameSettings.scoring.maxPointsForSpeedRunning,
                      speedRunLeniencyFactor: e.currentTarget.value,
                    })
                  }}
                  defaultValue={gameSettings.scoring.speedRunLeniencyFactor}
                  className="h-[4px] w-full cursor-pointer appearance-none border-transparent bg-neutral-200 dark:bg-neutral-600"
                  id="customRange1"
                />
                <p className="my-2">
                  <strong>Value:</strong>{' '}
                  {gameSettings.scoring.speedRunLeniencyFactor}
                </p>
              </div>
            </Form>
          </div>
